...
> `/start` отправляет кнопку открытия Mini App. Веб-панель откроется только при совпадении секретного номера **и** Telegram ID из списка операторов/администраторов.
