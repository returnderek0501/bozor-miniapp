...
**Клиент ≠ оператор:** клиент — человек в CRM; оператор — кто ведёт клиента (отдельные поля).  
**Теги** — действия клиента (паспорт, договор). Фото **необязательно**, но можно прикрепить.  
Админ: кнопка «Все фото» или лист «Фото» в Excel/Sheets.

**Роли:** оператор видит клиентов, которых **ведёт** (назначен оператором). Админ — всех.  
**Экспорт** (`/export`) — только админам.
