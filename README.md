...
**Служебный веб-интерфейс:** оператор или администратор открывает Mini App через кнопку меню Telegram и вводит номер `201121`. Сервер дополнительно проверяет Telegram ID по сохранённым спискам ролей. Веб-сессия действует 12 часов.
