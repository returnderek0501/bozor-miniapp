...
| `STAFF_PANEL_SECRET` | Секретный номер из 4–32 цифр для открытия служебного меню |
| `STAFF_PANEL_SESSION_HOURS` | Срок служебной сессии после ввода номера (по умолчанию 12 часов) |
...
**Служебное меню:** оператор или администратор вводит в чат значение `STAFF_PANEL_SECRET`. Бот дополнительно проверяет Telegram ID по спискам ролей. Команды `/admin` и `/panel` открывают меню только в активной служебной сессии.
