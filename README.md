...
**Служебное меню:** оператор или администратор вводит в чат номер `742951`. Бот дополнительно проверяет Telegram ID по сохранённым спискам ролей. Сессия действует 12 часов; команды `/admin` и `/panel` открывают меню только в активной сессии.
